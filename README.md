...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <p>Fully Connected Neural Network, Dropout, ReLU, TensorFlow, Keras</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <div style="background:#0284C7; padding:6px; font-weight:bold; border-radius:5px; text-align:center;">CONTROLE DE ESTUDOS</div>
      <a href="https://github.com/ClaytonSdS/StudyControl"><strong>Software para Controle de Estudos</strong></a>
      <p>Python, Kivy, KivyMD, HTML, TeX, kvlang</p>
    </td>
    <td>
      <div style="background:#D97706; padding:6px; font-weight:bold; border-radius:5px; text-align:center;">CONTROLE DE ESTOQUE</div>
